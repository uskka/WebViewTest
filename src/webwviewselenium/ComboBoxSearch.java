...
public class ComboBoxSearch extends PlainDocument {
    JComboBox comboBox;
    ComboBoxModel model;
    ...
    public ComboBoxSearch(final JComboBox comboBox) {
    ...
    public static JComboBox createComboBox(String[] bookTitles) {
        // the combo box (add/modify items if you like to)
        JComboBox comboBox = new JComboBox(bookTitles);
        // has to be editable
        comboBox.setEditable(true);
        // change the editor's document
        new ComboBoxSearch(comboBox);
